...
<main class="main-layout">
        ...
        <section class="posts">
            <article class="post-teaser">
                ...
                <div class="post-content">
                    <h2 class="post-title">How to patch KDE on FreeBSD?</h2>
    ...
    <aside class="right-panel">
        <section class="panel-section">
            <header class="panel-header">
                <div class="panel-title">
                    <img src="https://cdn.builder.io/api/v1/image/assets/TEMP/71947582d7c9427122d4ddc0ab0089891bca75ea?placeholderIfAbsent=true&apiKey=6403d12017614190bab75befab4eae62"
                        class="panel-icon" alt="Must-read icon" />
                    <h2 class="panel-heading">Must-read posts</h2>
                </div>
            ...
            <nav class="panel-links">
                <a href="#" class="panel-link">
                    ...
                    <span class="link-text">Please read rules before you start working on a platform</span>
                </a>
                <a href="#" class="panel-link">
                    <span class="bullet">•</span>
                    <span class="link-text">Vision & Strategy of Alemhelp</span>
                </a>
            </nav>
        </section>
        ...
        <section class="panel-section">
            <header class="panel-header">
                <div class="panel-title">
                    <img src="https://cdn.builder.io/api/v1/image/assets/TEMP/366ae031611c9509a7bbd99acf5067a517e91007?placeholderIfAbsent=true&apiKey=6403d12017614190bab75befab4eae62"
                        class="panel-icon" alt="Featured links icon" />
                    <h2 class="panel-heading">Featured links</h2>
                </div>
                <hr class="panel-divider" />
            </header>
            <nav class="panel-links">
                <a href="#" class="panel-link">
                    <span class="bullet">•</span>
                    <span class="link-text">Alemhelp source-code on GitHub</span>
                </a>
                <a href="#" class="panel-link">
                    <span class="bullet">•</span>
                    <span class="link-text">Golang best-practices</span>
                </a>
                <a href="#" class="panel-link">
                    <span class="bullet">•</span>
                    <span class="link-text">Alem.School dashboard</span>
                </a>
            </nav>
        </section>
    </aside>
